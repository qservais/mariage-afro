...
import { MapPin, CalendarDays, Heart, Loader2, Clock } from "lucide-react";
import {
  WEDDING_TEMPLATES,
  normalizeTemplate,
...
function RsvpBlock({ site, slug, formattedDate, palette, t }: LayoutProps) {
    ...
    <section className="py-20 px-6 max-w-lg mx-auto">
      ...
      >
        ...
        <a
          ...
          className="inline-flex items-center justify-center w-full h-12 font-bold uppercase tracking-wider text-sm px-6 transition-opacity hover:opacity-90"
...
function CagnotteFooter({ slug, palette, t }: LayoutProps) {
  return (
    <>
      <section
